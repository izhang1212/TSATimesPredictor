...
function SidePanel({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className={`fixed inset-0 z-50 bg-stone/40 backdrop-blur-sm transition-opacity duration-300 ${
      ...
      {/* Panel */}
      <aside
        className={`fixed top-0 right-0 z-50 h-full w-80 bg-white shadow-2xl transition-transform duration-300 ease-out ${
